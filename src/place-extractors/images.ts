...
import { navigateBack } from '../utils/misc-utils.js';
...
export const extractImages = async (
    { page, maxImages, targetReviewsCount, placeUrl }
    : { page: Page, maxImages: number, targetReviewsCount: number, placeUrl: string },
